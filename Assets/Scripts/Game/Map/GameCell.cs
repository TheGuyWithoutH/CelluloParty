...
namespace Game.Map
{
    public enum GameCell
    {
        ...
        [CellAttribute(1.8, -9.3,  1.8, -8.26)] Cell6,
        [CellAttribute(0.75, -9.3,  1.8, -8.26)] Cell7,
        [CellAttribute(0.75, -8.4,  1.8, -8.26)] Cell8,
        [CellAttribute(0.75, -7.4,  1.8, -7.4)] CellRiver,
